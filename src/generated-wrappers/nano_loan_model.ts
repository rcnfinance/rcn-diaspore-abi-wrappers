...
export type NanoLoanModelEventArgs =
    | NanoLoanModel_setEngineEventArgs
    | NanoLoanModel_setDescriptorEventArgs
    | NanoLoanModel_setInterestEventArgs
    | NanoLoanModel_setPunitoryInterestEventArgs
    | NanoLoanModel_setInterestTimestampEventArgs
    | NanoLoanModelCreatedEventArgs
    | NanoLoanModelChangedStatusEventArgs
    | NanoLoanModelChangedObligationEventArgs
    | NanoLoanModelChangedFrequencyEventArgs
    | NanoLoanModelChangedDueTimeEventArgs
    | NanoLoanModelChangedFinalTimeEventArgs
    | NanoLoanModelAddedDebtEventArgs
    | NanoLoanModelAddedPaidEventArgs
    | NanoLoanModelOwnershipTransferredEventArgs;

export enum NanoLoanModelEvents {
    _setEngine = '_setEngine',
    _setDescriptor = '_setDescriptor',
    _setInterest = '_setInterest',
    _setPunitoryInterest = '_setPunitoryInterest',
    _setInterestTimestamp = '_setInterestTimestamp',
    Created = 'Created',
...
export interface NanoLoanModel_setEngineEventArgs extends DecodedLogArgs {
    _engine: string;
}

export interface NanoLoanModel_setDescriptorEventArgs extends DecodedLogArgs {
    _descriptor: string;
}

export interface NanoLoanModel_setInterestEventArgs extends DecodedLogArgs {
    _id: string;
    _interest: BigNumber;
}

export interface NanoLoanModel_setPunitoryInterestEventArgs extends DecodedLogArgs {
    _id: string;
    _punitoryInterest: BigNumber;
}

export interface NanoLoanModel_setInterestTimestampEventArgs extends DecodedLogArgs {
    _id: string;
    _interestTimestamp: BigNumber;
}

export interface NanoLoanModelCreatedEventArgs extends DecodedLogArgs {
    _id: string;
}

export interface NanoLoanModelChangedStatusEventArgs extends DecodedLogArgs {
    _id: string;
    _timestamp: BigNumber;
    _status: BigNumber;
}

export interface NanoLoanModelChangedObligationEventArgs extends DecodedLogArgs {
    _id: string;
    _timestamp: BigNumber;
    _debt: BigNumber;
}

export interface NanoLoanModelChangedFrequencyEventArgs extends DecodedLogArgs {
    _id: string;
    _timestamp: BigNumber;
    _frequency: BigNumber;
}

export interface NanoLoanModelChangedDueTimeEventArgs extends DecodedLogArgs {
    _id: string;
    _timestamp: BigNumber;
    _status: BigNumber;
}

export interface NanoLoanModelChangedFinalTimeEventArgs extends DecodedLogArgs {
    _id: string;
    _timestamp: BigNumber;
    _dueTime: BigNumber;
}

export interface NanoLoanModelAddedDebtEventArgs extends DecodedLogArgs {
    _id: string;
    _amount: BigNumber;
}

export interface NanoLoanModelAddedPaidEventArgs extends DecodedLogArgs {
    _id: string;
    _paid: BigNumber;
}

export interface NanoLoanModelOwnershipTransferredEventArgs extends DecodedLogArgs {
...
export class NanoLoanModelContract extends BaseContract {
    ...
    public supportsInterface = {
        ...
        > {
            const self = this as any as NanoLoanModelContract;
    ...
    public configs = {
        ...
        > {
            ...
            // tslint:disable boolean-naming
            const result = abiEncoder.strictDecodeReturnValue<[BigNumber, BigNumber, BigNumber, BigNumber, string]
        >(rawCallResult);
            // tslint:enable boolean-naming
            return result;
        },};
    public transferOwnership = {
        async sendTransactionAsync(
            ...
            const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
                ...
                self.transferOwnership.estimateGasAsync.bind<NanoLoanModelContract, any, Promise<number>>(
                    self,
                    _newOwner
    ,
                    estimateGasFactor,
    ...
    public setEngine = {
        async sendTransactionAsync(
            ...
            const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
                ...
                self.setEngine.estimateGasAsync.bind<NanoLoanModelContract, any, Promise<number>>(
                    self,
                    _engine
    ,
                    estimateGasFactor,
    ...
    public setDescriptor = {
        async sendTransactionAsync(
            ...
            const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
                ...
                self.setDescriptor.estimateGasAsync.bind<NanoLoanModelContract, any, Promise<number>>(
                    self,
                    _descriptor
    ,
                    estimateGasFactor,
    ...
    public encodeData = {
        async callAsync(
            ...
            _interestRatePunitory: BigNumber,
            _dueTime: BigNumber,
            _cancelableAt: BigNumber,
        callData: Partial<CallData> = {},
            defaultBlock?: BlockParam,
        ): Promise<string
        > {
            const self = this as any as NanoLoanModelContract;
            const encodedData = self._strictEncodeArguments('encodeData(uint128,uint256,uint256,uint64,uint64)', [_amount,
        _interestRate,
        ...
        _cancelableAt
            ...
            const rawCallResult = await self._web3Wrapper.callAsync(callDataWithDefaults, defaultBlock);
            BaseContract._throwIfRevertWithReasonCallResult(rawCallResult);
            const abiEncoder = self._lookupAbiEncoder('encodeData(uint128,uint256,uint256,uint64,uint64)');
            // tslint:disable boolean-naming
            const result = abiEncoder.strictDecodeReturnValue<string
        >(rawCallResult);
            // tslint:enable boolean-naming
    ...
    data
            ...
            const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
                ...
                self.create.estimateGasAsync.bind<NanoLoanModelContract, any, Promise<number>>(
                    self,
                    id,
    data
    ,
    ...
    amount
            ...
            const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
                ...
                self.addPaid.estimateGasAsync.bind<NanoLoanModelContract, any, Promise<number>>(
                    self,
                    id,
    amount
    ,
    ...
    public addDebt = {
        async sendTransactionAsync(
            ...
            const self = this as any as NanoLoanModelContract;
            const encodedData = self._strictEncodeArguments('addDebt(bytes32,uint256)', [index_0,
    index_1
    ]);
            const contractDefaults = self._web3Wrapper.getContractDefaults();
            const defaultFromAddress = (await self._web3Wrapper.getAvailableAddressesAsync())[0];
            const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
                ...
                self.addDebt.estimateGasAsync.bind<NanoLoanModelContract, any, Promise<number>>(
                    self,
                    index_0,
    index_1
    ,
    ...
    public run = {
        async sendTransactionAsync(
            ...
            const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
                ...
                self.run.estimateGasAsync.bind<NanoLoanModelContract, any, Promise<number>>(
                    self,
                    id
    ,
                    estimateGasFactor,
    ...
    public static async deployAsync(
        ...
        logUtils.log(`NanoLoanModel successfully deployed at ${txReceipt.contractAddress}`);
        const contractInstance = new NanoLoanModelContract(abi, txReceipt.contractAddress as string, provider, txDefaults);
        contractInstance.constructorArgs = [];
        return contractInstance;
    }
    constructor(abi: ContractAbi, address: string, supportedProvider: SupportedProvider, txDefaults?: Partial<TxData>, defaultEstimateGasFactor?: number) {
        super('NanoLoanModel', abi, address, supportedProvider, txDefaults);
