...
export class RateOracleContract extends BaseContract {
    ...
    public supportsInterface = {
        ...
        > {
            const self = this as any as RateOracleContract;
    ...
    public readSample = {
        async sendTransactionAsync(
            ...
            const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
                ...
                self.readSample.estimateGasAsync.bind<RateOracleContract, any, Promise<number>>(
                    self,
                    _data
    ,
                    estimateGasFactor,
    ...
    public static async deployAsync(
        ...
        logUtils.log(`RateOracle successfully deployed at ${txReceipt.contractAddress}`);
        const contractInstance = new RateOracleContract(abi, txReceipt.contractAddress as string, provider, txDefaults);
        contractInstance.constructorArgs = [];
        return contractInstance;
    }
    constructor(abi: ContractAbi, address: string, supportedProvider: SupportedProvider, txDefaults?: Partial<TxData>, defaultEstimateGasFactor?: number) {
        super('RateOracle', abi, address, supportedProvider, txDefaults);
