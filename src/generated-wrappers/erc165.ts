...
export class ERC165Contract extends BaseContract {
    ...
    public static async deployAsync(
        ...
        logUtils.log(`ERC165 successfully deployed at ${txReceipt.contractAddress}`);
        const contractInstance = new ERC165Contract(abi, txReceipt.contractAddress as string, provider, txDefaults);
        contractInstance.constructorArgs = [];
        return contractInstance;
    }
    constructor(abi: ContractAbi, address: string, supportedProvider: SupportedProvider, txDefaults?: Partial<TxData>, defaultEstimateGasFactor?: number) {
        super('ERC165', abi, address, supportedProvider, txDefaults);
